...
if(isset($_GET['id']) AND !empty($_GET['id'])){
    ...
    $checkIfQuestionExists = $bdd->prepare('SELECT id_auteur FROM questions WHERE id = ?', array($idOfTheQuestion)); // séléctionner toute les données dans notre table question qui posséde l'id rentré par l'utilisateur
